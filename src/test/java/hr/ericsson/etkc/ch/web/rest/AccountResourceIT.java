package hr.ericsson.etkc.ch.web.rest;

import static hr.ericsson.etkc.ch.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import hr.ericsson.etkc.ch.CovidKontaktiApp;
import hr.ericsson.etkc.ch.config.Constants;
import hr.ericsson.etkc.ch.domain.PersistentToken;
import hr.ericsson.etkc.ch.domain.User;
import hr.ericsson.etkc.ch.repository.AuthorityRepository;
import hr.ericsson.etkc.ch.repository.PersistentTokenRepository;
import hr.ericsson.etkc.ch.repository.UserRepository;
import hr.ericsson.etkc.ch.security.AuthoritiesConstants;
import hr.ericsson.etkc.ch.service.UserService;
import hr.ericsson.etkc.ch.service.dto.PasswordChangeDTO;
import hr.ericsson.etkc.ch.service.dto.UserDTO;
import hr.ericsson.etkc.ch.web.rest.vm.KeyAndPasswordVM;
import hr.ericsson.etkc.ch.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = CovidKontaktiApp.class)
